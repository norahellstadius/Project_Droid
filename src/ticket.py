...
class Ticket:
    ...
    get_ticket_title(self) -> str
        Prompts the user to enter a title for a ticket and checks its validity before returning. Saves provided title as an attribute
    ...
    def get_ticket_title(self) -> None:
        ...
        Saves the provided title as an attribute.
        ...
        while True:
            ...
            if len(words_in_title) == 1:
                ...
                print("To improve the final ticket quality, provide a more descriptive title.")
            elif bool(re.match(r"^\d+$", ticket_title)):
                print("Invalid input. Unable to create a ticket from a title that only contains digits.")
            else:
