...
class Ticket:
    ...
    def iterative_refinement(self, text, type: str):
        ...
        if type == "acceptance_criteria":
            ...
            example = """
                ...
                """
            prompt_st = f"""Improve the Jira ticket section {type} given by {text} to be concise and clear, following the same structure as the example:\n{example}"""
            st_text = model.get_answer(prompt_st)["content"]
            subtasks_text_clean = self.clean_text(st_text, True)

            return subtasks_text_clean
        else:
            raise ValueError(
